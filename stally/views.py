...
def campaign_list(request):
    ...
    return render(request, 'stally/campaign_list.html',
                  {'campaigns': campaigns})
...
def campaign_character_list(request, pk):
    ...
    return render(request, 'stally/campaign_character_list.html',
...
def character_pokemon_list(request, pk):
    ...
    return render(request, 'stally/character_pokemon_list.html',
...
def campaign_pokemon_list(request, pk):
    ...
    return render(request, 'stally/campaign_pokemon_list.html',
                  {'campaign': campaign, 'pokemons': pokemons})


def campaign_npc_list(request, pk):
    campaign = get_object_or_404(Campaign, pk=pk)
    return render(request, 'stally/campaign_npc_list.html',
                  {'campaign': campaign})


def campaign_detail(request, pk):
    campaign = get_object_or_404(Campaign, pk=pk)
    return render(request, 'stally/campaign_detail.html',
                  {'campaign': campaign})


def character_detail(request, pk):
    character = get_object_or_404(Character, pk=pk)
    return render(request, 'stally/character_detail.html',
                  {'character': character})
